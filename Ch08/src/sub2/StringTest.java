...
public class StringTest {
		public static void main(String[] args) {
			...
			//문자열 비교 (문자열비교는 equals로)
			if(str1==str2) /* stack 주소를비교*/ {
				System.out.println("str1과 str2가 같다.");
			}else {
				System.out.println("str1과 str2가 다르다.");
			}
			
			if(str1.equals(str2)) /* 객체 값을비교*/ {
			...
			System.out.println("str7에서 마지막까지 자르기 : "+str.substring(6));
			...
			//문자열 교체
			System.out.println("str 문자열에서 hello를 welcome으로 교체 :"+ str.replace("Hello", "Wellcome"));
